...
document.addEventListener("DOMContentLoaded", function(){
	document.addEventListener("deviceready", function() {
		...
		function getThumbnails() {
			var url = "http://faculty.edumedia.ca/griffis/mad9022/final-w15/list.php?dev=d38294b1402b17f2";
		...
		function saveImage(ev){
			...
			var postData = "dev=d38294b1402b17f2&thumb=" + thumbpng + "&img=" + fullpng;
			sendRequest(url, imgSaved, postData);
		}

		function deletePhoto(ev){
			var id = ev.target.parentNode.parentNode.getAttribute("data-ref");
			var url = "http://faculty.edumedia.ca/griffis/mad9022/final-w15/delete.php?dev=d38294b1402b17f2&img_id="+id;
